...
class ObjectDetection:
    ...
    def __init__(self, iface):
        ...
        self.toolbar = self.iface.addToolBar(u'ObjectDetection')
        self.toolbar.setObjectName(u'ObjectDetection')
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            #print "** STARTING ObjectDetection"
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = ObjectDetectionDockWidget()
